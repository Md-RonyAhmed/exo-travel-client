         ...
         <div className="text-center mt-12 z-10">
           ...
           <div className="lg:py-12 p-8 -mt-10 ">
             ...
             <p className="w-full mx-auto mb-10 mt-5 lg:text-2xl text-lg text-[#5e6163]">
               ...
               destinations by minimising negative impacts and maximising
               positive ones for both the environments we operate in, and the
               people living in them. A steadfast commitment to responsible
               travel is vital to our ethos.
             </p>
             <p className="w-full mx-auto mb-10 mt-5 lg:text-2xl text-lg px-4 text-[#5e6163]">
               ...
               follow. To further guide our responsible practices, we created
               the DMC Foundation. Operating independently of DMC Travel, the
               Foundation actively supports a wide range of sustainability
               programs and audits DMC Travel to keep us on track with global
